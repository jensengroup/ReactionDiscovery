    ...
    for run in range(100):
        ...
        for reaction in run_df.Reactions:
            if reaction in rxn_df.Reactions.to_list() or reaction.split('>>')[1]+'>>'+reaction.split('>>')[0] in rxn_df.Reactions.to_list():
                ...
                r_hash = structure_df.index[structure_df.smiles == reaction.split('>>')[0]].to_list()[0]
                ...
                for _ in range(count_list[cur_idx]):
                    ...
                    JOB_DF.loc[(r_idx, idx, current_letter), 'reactant_smiles_am'] = reaction.split('>>')[0]
                    JOB_DF.loc[(r_idx, idx, current_letter), 'product_smiles_am'] = reaction.split('>>')[1]
